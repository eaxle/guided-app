        ...
        return (
            <div className="container-fluid2 container ">
                <ListGroup>
                    ...
                    <ListGroupItem className="subtext-left titleSize"><NavLink to={{pathname: "/setting/PersonInf"}}
                                                                               className="inactive"
                    ...
                    <ListGroupItem className="subtext-left" hearder=""><NavLink
                        to={{pathname: "/setting/officialdoc"}} className="inactive" activeClassName="active"
                        exact={true}><h4 className="normal">Official Documents (h4 normal)</h4></NavLink>
                    ...
                    <ListGroupItem className="subtext-left"><NavLink to={{pathname: "/setting/ad"}} className="inactive"
                                                                     activeClassName="active" exact={true}>
