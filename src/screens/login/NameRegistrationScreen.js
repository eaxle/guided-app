   ...
   <div className="container-fluid text-center d-flex justify-content-center align-items-center container ">
    ...
    <div className="row">
        <div className="col-sm-12">
            <input type="text" placeholder="First Name" className="col-sm-4 form-control form-control-sm  " />
            </div>
            <div className="col-sm-12">
            <input type="text" placeholder="Last Name" className="col-sm-4 form-control form-control-sm  " />
            </div>
            <NavLink
