      ...
      <div className="row col-sm-12 welcome">Welcome to Guided
           ...
           <table>
             ...
             <td><label >Male</label></td>
               <td> <input type="radio" value="m" name="gender" checked onChange={this.handleFormData}/></td>
             </tr>
             <tr>
               <td><label >Female</label></td>
               <td><input type="radio" value="f" name="gender" onChange={this.handleFormData}/></td>
             </tr>
             <tr>
               <td><label >other</label></td>
               <td> <input type="radio" value="o" name="gender" onChange={this.handleFormData}/></td>
             </tr>
           </table>
